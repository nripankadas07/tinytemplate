...
`tinytemplate`: Zero-dep ${name} template renderer with defaults, dotted-path access, and a small filter chain (upper/lower/title/strip/trim/len/reverse + custom)..
